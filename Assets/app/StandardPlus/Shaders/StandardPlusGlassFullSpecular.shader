...
Shader "Standard Plus/Standard Plus Glass Full (Specular Setup)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature _FULLBACKGROUND 
	...
	CustomEditor "StandardPlusGlassFullGUI" //Standard Plus Code
}
