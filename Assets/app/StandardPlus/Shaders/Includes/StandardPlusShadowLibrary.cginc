...
#ifndef STANDARD_PLUS_SHADOW_LIBRARY_INCLUDED //Standard Plus Code
#define STANDARD_PLUS_SHADOW_LIBRARY_INCLUDED //Standard Plus Code

// Shadowmap helpers.

#if defined( SHADOWS_SCREEN ) && defined( _CUSTOM_LIGHTMAP ) //Standard Plus Code
...
//        #if defined(LIGHTMAP_ON) && !defined(_CUSTOM_LIGHTMAP)
//            fixed4 rawOcclusionMask = UNITY_SAMPLE_TEX2D_SAMPLER(unity_ShadowMask, 0, lightmapUV.xy);
//        #else
...
//    #if defined (SHADOWS_SHADOWMASK)
//        #if defined(LIGHTMAP_ON) && !defined(_CUSTOM_LIGHTMAP)
//            return UNITY_SAMPLE_TEX2D_SAMPLER(unity_ShadowMask, 0, lightmapUV.xy);
//        #else
