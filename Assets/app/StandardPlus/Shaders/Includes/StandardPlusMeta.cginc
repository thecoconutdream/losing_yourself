...
#ifndef STANDARD_PLUS_META_INCLUDED //Standard Plus Code
#define STANDARD_PLUS_META_INCLUDED //Standard Plus Code
...
{
    v2f_meta o;
    o.pos = UnityMetaVertexPosition(v.vertex, v.uv1.xy, v.uv2.xy, 0, unity_DynamicLightmapST);
    o.uv = TexCoords(v);
    return o;
}
